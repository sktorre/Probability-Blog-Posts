...
P(s1 = car) + P(s2 = car) - P(s1 = car)P(s2 = car) = P(car >= 1)
...
|:-------:|:-------:|:------:|:-------:|
|         |  0.68   |  0.32  |         | row
| FL >=37 | 0.4055  |  0.191 | 0.5965  | cell
|         |  0.811  |  0.38  |         | column
|---------|---------|--------|---------|
|         |  0.234  | 0.766  |         | row
| FL < 37 | 0.0945  | 0.3095 |  0.404  | cell
|         |  0.189  | 0.619  |         | column
|---------|---------|--------|---------|    
|         |   0.5   |  0.5   |    1    |
...
Under the new capped policy the variance is 7.03 ($7,030). This is a pretty large variance considering the expected value of 1.95, but it makes sense in this mixture distribution because typically students will either have \$0 in hospital charges or a larger bill. 
