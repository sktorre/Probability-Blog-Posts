...
The estimated median of my sample is `r round(est_med,3)`. The graph above shows the sampling distribution of the estimated median. 
```{r}
...
```
I found the coverage probability to be `r cov_prob`, meaning `r cov_prob*100`% of the time we take a sample of the true population it will contain the median. 
